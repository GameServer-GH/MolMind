...
class CtxClient:
    def __init__(
        ...
        *,
        ...
        self.base_url = str(base_url or CTX_BASE).rstrip("/")
        ...
        for attempt in range(self.retries):
            try:
                if self.before_request is not None:
                    self.before_request()
                # The base URL is an audited provider-policy input.  Production
                # defaults to EPA CTX; tests may inject a local HTTP fixture.
