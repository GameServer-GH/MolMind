...
from plugins.molmind_core.scientific.nomination.review import _relabel_tiers, _sort_primary_by_selection
from plugins.molmind_core.scientific.pipeline.export import rows_from_top, to_csv_text
...
def build_interactive_review_proposals(
    ...
    *,
    ...
    if use_llm:
        try:
            from plugins.molmind_core.scientific.nomination.llm_review import run_llm_nomination_review
